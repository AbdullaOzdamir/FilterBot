...
public class Bot extends TelegramLongPollingBot {
    ...
    public String getBotUsername() {
        return "JavaFilterBot";
    }

    @Override
    public String getBotToken() {
        return "6831367352:AAFtk-yTmrUAYxOhMhSwEF-vC6jbbsX69zk";
    }
    ...
    private SendMessage runPhotoMessage(Message message) {
        ...
        List<org.telegram.telegrambots.meta.api.objects.File> files = getFileByMessage(message);
        if (files.isEmpty())
            return null;
