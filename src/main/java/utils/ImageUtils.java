...
public class ImageUtils {
    ...
    static public BufferedImage getImages(String path) throws IOException {
        final File file = new File(path);
        return ImageIO.read(file);
    }

    static public void saveImages(BufferedImage image, String path) throws IOException {
    ...
    static int arrayToRgbInt(float[] pixel) throws Exception {
        ...
        throw new Exception("Invalided color");
    }
